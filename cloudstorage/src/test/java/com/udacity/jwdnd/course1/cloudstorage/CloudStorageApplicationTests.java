...
class CloudStorageApplicationTests {
	...
	public void testRedirection() {
		...
		WebElement goToLogin=driver.findElement(By.id("goToLogin"));
		goToLogin.click();
...
@Test
	public void testUserSignupAndLogin(){
		...
		signupPage.signup("Noura","AB",username,password);
...
@Test
	public void testCreateAndDisplayNote(){
		String noteTitle= "Greetings";
		String noteDescription="Hello";
...
@Test
	public void testVerifyAndEditCredential(){
		testCreateAndDisplayCredential();

		String editedUrl="http:/Greetings.com";
		String editedUsername="user";
		String editedPassword="b1";
